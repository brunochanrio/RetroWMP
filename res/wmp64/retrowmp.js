...
{
    if(
        player.PlayState == psBuffering ||
        player.PlayState == psTransitioning ||
        player.PlayState == psReconnecting ||
        player.PlayState == psWaiting)
    {
        wmlogo.backgroundImage = 'icon_wmlogo_animated.gif';
    } 
    else
    {
        wmlogo.backgroundImage = 'icon_wmlogo.bmp';
    }
